<h2><a href="https://leetcode.com/problems/shortest-subarray-with-sum-at-least-k/">891. Score After Flipping Matrix</a></h2><h3>Medium</h3><hr><p>You are given an <code>m x n</code> binary matrix <code>grid</code>.</p>
